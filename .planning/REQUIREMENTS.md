...
- [x] **RES-05**: User can browse SCSC facilities and book hourly slots (including recurring weekly)
- [x] **RES-06**: User can cancel bookings (including bulk cancel for recurring)
- [x] **RES-07**: User can view Discover page with announcements, newsletters, and promotions
- [x] **RES-08**: User can view Info Centre with categorized knowledge base articles
- [x] **RES-09**: User can view and manage notification preferences
...
- [x] **UX-01**: Multi-language support (English + Myanmar) via next-intl or equivalent
- [x] **UX-02**: Dark mode with system detection and manual toggle
- [x] **UX-03**: Mobile-first responsive layout with bottom navigation (resident)
- [x] **UX-04**: PWA/offline support with cache-first strategy
- [x] **UX-05**: Loading states and error boundaries for Server Components

### Testing & CI

- [x] **TEST-01**: Unit tests migrated to Next.js test infrastructure (Vitest or Jest)
- [x] **TEST-02**: API route integration tests covering auth, bills, tickets, bookings
...
| RES-05 | Phase 27 | Complete |
| RES-06 | Phase 27 | Complete |
