...
- [x] 21-02-PLAN.md — Frontend useTicketChat hook with WS + polling fallback, UI integration for both apps
**UI hint**: yes
...
**Plans**: 2 plans
Plans:
- [ ] 23-01-PLAN.md — Playwright setup + login and dashboard E2E test
