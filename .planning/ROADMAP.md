...
- [ ] **Phase 33: UI Polish** — Restore brand warmth on auth pages, strengthen bottom nav, verify status badge rendering and admin/resident visual distinction
